...
List<CatbreedsModel> catbreedsModelFromJson(String str) =>
    List<CatbreedsModel>.from(
        json.decode(str).map((x) => CatbreedsModel.fromJson(x)));

String catbreedsModelToJson(List<CatbreedsModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

CatbreedsModel catbreedModelFromJson(String str) =>
    CatbreedsModel.fromJson(json.decode(str));

String catbreedModelToJson(CatbreedsModel data) =>
    json.encode(data.toJson());

class CatbreedsModel implements CatbreedsModelInterface {
  @override
  Weight? weight;
  @override
  String? id;
  ...
  CatbreedsModel copyWith({
    ...
    String? urlReferenceImage,
      ...
      CatbreedsModel(
        ...
        urlReferenceImage: urlReferenceImage ?? this.urlReferenceImage,
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "urlReferenceImage": urlReferenceImage
      };
}

class Weight implements WeightModelInterface {
  @override
  String? imperial;
  @override
  String? metric;
